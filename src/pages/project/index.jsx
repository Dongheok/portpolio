...
const sub_project_data = [
  ...
  },
  {
    project_title: "맥도날드",
    project_text_1:
      "(메인,서브)페이지를 디자인하여 시안을 직접 제작해서 UI를 구현할 수 있습니다.",
    // project_text_2: '',
  ...
  },
  {
    ...
    project_text_2:
      "비디오 슬라이드를 구현할 수 있고, 모달 팝업을 구현할 수 있습니다.",
              ...
              {main_project_data.map((x, index) => {
                return (
                  <Grid className="slide">
                    <Mask
                      height="600px"
                      bgUrl={`/portpolio/images/project/main_project_${
                        index + 1
                      }.png`}
                    />
                    <Grid className="link">
                ...
                return (
                  ...
                  >
                    <Grid className="item_wrap">
                      <Mask
                        height="380px"
                        bgUrl={`/portpolio/images/project/project_${
                          index + 1
                        }.png`}
                      />
                      <Grid className="text">
