         ...
         <Grid container justify="space-between" direction="row" className="about">
            ...
            <Grid item className="info">
               ...
               <Grid container direction="column" className="">
                  ...
                  <Grid item className="text">
                     안녕하세요! <b>당근마켓에 산업기능요원 보충역(시력이슈) 신입 프론트엔드 개발자</b>로 지원한 <b>김동혁</b>입니다. 저의
                     가장 큰<b>장점</b>은 호기심이 많고 적극적입니다. 궁금한 것은 귀찮을 정도로 잘 물어보고 답을 찾기 위해서라면 끝까지 쫒아
                     다닙니다. 항상 제가 맡은일에 <b>책임감</b>을 가지고 <b>최선</b>을 다하려고 노력합니다. 아직 제가 만든 웹
                     애플리케이션들을 사용자가 사용하고 피드백을 받아본 경험이 없습니다. <b>당근마켓</b>에 입사하여 즐거운 분위기에서 신규
                     웹 애플리케이션 서비스를 개발하여 실시간으로 <b>방대한 유저</b>한테 <b>피드백</b>을 받고 더 좋은 서비스를 만드는{' '}
                     <b>프론트엔드 개발자</b>로 <b>당근마켓</b>과 함께 성장하고 싶습니다. 감사합니다!
                     <br />
                  </Grid>
               </Grid>
            </Grid>
