         ...
         <Grid container justify="space-between" direction="row" className="about">
            ...
            <Grid item className="info">
               ...
               <Grid container direction="column" className="">
                  ...
                  <Grid item className="text">
                     안녕하세요! <b>산업기능요원 보충역(시력이슈) 신입 프론트엔드 개발자</b>로 <b>지그재그</b>에 지원한 <b>김동혁</b>입니다.
                     ...
                     <br />
                     아직 제가 만든 웹 애플리케이션들을 사용자가 사용하고 피드백을 받아본 경험이 없습니다. 새로운 웹 어플리케이션을 만들어
                     보고 겪으며 실시간으로 <b>방대한 유저</b>한테 <b>피드백</b>을 받고 더 좋은 서비스를 만드는 지그재그의
