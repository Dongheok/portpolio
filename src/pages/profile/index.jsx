...
import { Wrapper, Skill } from './styles';
         ...
         <Layout>
            <Grid className="profile">
                  ...
                  <Grid container className="info">
                     ...
                     <Grid item xs={12} sm={7} md={9} className="info">
                        ...
                        <Grid container direction="column" className="">
                           ...
                           <Grid item className="text">
                              안녕하세요! 산업기능요원으로 편입을 준비하는 신입 프론트엔드 개발자 김동혁입니다.
                           </Grid>
                        </Grid>
                     </Grid>
                  </Grid>
               ...
               <Grid className="skill">
                  ...
                  <Grid container justify="center" className="skill_wrap">
                     <Grid item className="skill_item green">
                        <Grid className="skill_content">
                           <Grid className="title">HT</Grid>
                           <Grid className="text">Html5</Grid>
                        </Grid>
                     </Grid>
                  </Grid>
               </Grid>
