export const portPolioData = {
   ...
   sub_project_data: [
      ...
      // SHUTTLEB
      {
         ...
         //  project_text_2: '서버와 통신하는 첫 동적 페이지였고 프로젝트를 하는 과정에서 동기/비동기, Redux, 공통으로 쓰는 부분 컴포넌트화',
         link: '',
      },
      // XY
      {
         ...
         project_text_2: 'React환경에서 Styled-Components와 Material-UI를 이용한 반응형 정적페이지입니다.',
      ...
      // 파이어니
      {
         ...
         project_text_2: '직접 이벤트페이지를 디자인하여 React를 이용해 구현한 첫 React 프로젝트입니다.',
         link: '',
      },
      {
         project_title: '맥도날드',
