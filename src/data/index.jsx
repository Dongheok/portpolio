export const portPolioData = {
   ...
   main_project_data: [
      {
         ...
         project_text_2: `["사용언어"]를 이용하여 구현한 최신, 인기, 공개 예정인 영화와 TV프로그램의 포스터, 별점, 영화 정보, 검색기능, 영화페이지 링크, 유튜브 영화 예고편까지 한 눈에 볼 수 있는 반응형 영화 웹 사이트입니다.검색 페이지에서 검색을 하고 새로고침을 해도 전에 검색한 기록을 가져오고, Axios를 보다 더 효율적으로 쓴 오픈 API를 이용한 React + TypeScript 프로젝트입니다.`,
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_dongflix.png',
   ...
   sub_project_data: [
      ...
      // 배달의딜러CMS
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_delivery.png',
         link: '',
         git: '',
         speed: 20,
         loading: true,
      ...
      // 동네선수CMS
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_plant.png',
         link: '',
         git: '',
         speed: 20,
         loading: true,
      ...
      // SSAFY CMS
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_ssafy_cms.png',
         link: '',
         git: '',
         speed: 20,
         loading: true,
      ...
      // SHUTTLEB
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_shuttleb.png',
         link: '',
         git: '',
         speed: 20,
         loading: true,
      ...
      // 손사찾기
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_sonsa.png',
      ...
      // SSAFY
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_ssafy.png',
         link: '',
         git: '',
         speed: 20,
         loading: true,
      ...
      // SV Data
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_svdata.png',
      ...
      // SV VIBA
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_svviba.png',
      ...
      // 파이어니
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_piony.png',
         link: '',
         git: '',
         speed: 10,
         loading: true,
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_appleclone.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_mcdonald.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_subway.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_hyundai.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_canon.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_samyang.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_netmarble.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_coffin.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_domino.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_posco.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_podopot.png',
      ...
      },
      {
         ...
         img: 'http://sn237x.cafe24.com/web/portpolio_img/project/project_lesposac.png',
