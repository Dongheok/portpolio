export const portPolioData = {
   ...
   skill_data: [
      ...
      },
      {
         ...
         lang: 'ES6',
         color: 'green',
         explanation: 'let, const, 스프레드 연산자, Arrow Function과 같은 ES6 기초를 이해하고 ES6의 함수형 프로그래밍을 해봤습니다.',
      },
      {
         keyword: 'NJ',
         lang: 'Node Js',
      ...
      },
      {
         ...
         lang: 'Typescript',
         color: 'yellow',
         explanation: 'Typescript 기초를 이해하여 영화 웹 사이트를 React와 Typescript를 사용하여 만들 수 있습니다.',
      },
      {
         keyword: 'NJ',
         lang: 'Next Js',
         color: 'green',
         explanation: 'Next JS를 이용하여 SEO가 된 정적 페이지를 구현할 수 있습니다.',
      },
      {
         keyword: 'ST',
      ...
      },
      {
         ...
         lang: 'Cross Browsing',
         color: 'red',
         explanation: '진행하는 프로젝트가 모든 브라우저에서  크로스 브라우징이 잘 되게 할 수 있습니다.',
      },
      {
         keyword: 'GT',
         lang: 'Git',
   ...
   sub_project_data: [
      ...
      {
         project_title: '손사찾기',
         project_text_1: '사용언어 : React, Styled-Components, Material-UI, Next-JS',
         project_text_2:
            'Next-JS를 이용하여 구현한 반응형 페이지입니다. 프로젝트를 하는 과정에서 이메일 서비스를 구현과 SEO(검색 엔진 최적화)를 하고 서버 사이드 렌더링 방식을 이해해 Next-Js를 이용하여 React 프로젝트에서 서버 사이드 렌더링을 할 수 있게 되었습니다.',
      ...
      },
      {
         ...
         project_text_2: '모바일 웹뷰 기반의  페이지를 유연하게 다루기 위해 구현한 대기업 모바일 웹뷰 사이트입니다.',
      ...
      },
      {
         project_title: '포도팟',
         project_text_1: '사용언어 : HTML, CSS3, Javascript, Jquery',
         project_text_2: '애니메이션 작동원리를 이해한 후, 구현한 애니메이션 웹사이트입니다.',
      ...
      },
      {
         project_title: '레스포삭',
         project_text_1: '사용언어 : HTML, CSS3, Javascript, Jquery',
         project_text_2: '정적페이지를 유연하게 다루기 위해 구현한 쇼핑몰 웹사이트입니다.',
