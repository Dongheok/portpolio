        ...
        <Wrapper>
            <Grid className="Profile">
                <Grid container className="Info">
                    <Grid xs={12} md={4} className="Picture">
                        <Grid className="Picture_Box"></Grid>
                    </Grid>
                    <Grid xs={12} md={8} className="Title">
                        <Grid>
                            <h2>저는 웹 프론트엔드 개발자 김동혁입니다.</h2>
                            <h3>성실하고 섬세하며 책임감이 강합니다.</h3>
                            <h3>
                                저의 가장 큰 장점은 호기심이 많고 적극적입니다. 궁금한 것은 귀찮을 정도로 잘 물어보고 답을 찾기 위해서라면
                                끝까지 쫒아 다닙니다. 그래서인지 관심사가 다양해져 처음 만나는 사람과 대화를 나누는데 공통분모를 많이 가질
                                수 있어서 대화를 막힘없이 이끌어 갈 수있게 되어서 좋습니다. 어떤 환경에서도 잘 적을할 수 있고 상황
                                대처능력이 뛰어납니다.
                            </h3>
                            <h3>
